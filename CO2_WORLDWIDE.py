...
#COHEFICIENTE DE DETERMINACION R2
    ...
    col5.metric(label="**COEFICIENTE DE DETERMINACION R^2**", value=f'   0.8167%')
    empi2.empty()
    st.write("##")
...
#PRIMEROS INSIGHTS
    ...
    with insight_222:
        #POBLACION HURBANA
        insight_222.metric(label="**POBLACIN URBANA**", value=f' ➕🚻  =  ➕CO2', delta="+ CONSCETRACION URBANA + CO2", delta_color="off")
